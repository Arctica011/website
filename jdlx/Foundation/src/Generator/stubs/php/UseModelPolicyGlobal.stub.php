...
trait Use__MODEL__PolicyGlobal
{
    /**
    ...
    {
        return $userWithRequest->hasPermissionTo("__CAMEL_MODEL__.view.{$__CAMEL_MODEL__->id}");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("__CAMEL_MODEL__.create");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("__CAMEL_MODEL__.update.{$__CAMEL_MODEL__->id}");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("__CAMEL_MODEL__.delete.{$__CAMEL_MODEL__->id}");
    }
    ...
    {
        return $userWithRequest->hasPermissionTo("__CAMEL_MODEL__.restore.{$__CAMEL_MODEL__->id}");
    }

    /**
     * Determine whether the user can permanently delete the model.
     *
     * @param \App\Models\__MODEL__ $userWithRequest
     * @param \App\Models\__MODEL__ $__CAMEL_MODEL__
     * @return bool
     */
